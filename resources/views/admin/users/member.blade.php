        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pull-right">
                    <a class="btn aqua" href="{{ route('admin.users.member.create') }}"><i class="fa fa-plus"></i> Add New Data</a>
                </div>
            </div>
        </div>
        <div class="row">
                                    ...
                                    <table id="example7" class="display nowrap table  responsive nowrap table-bordered">
                                        ...
                                        @foreach($model as $row)
                                            <tr>
                                                ...
                                                <td>{{ $row->getStatus() }}</td>
                                                <td>
                                                    <!-- <a href="{{ route('admin.users.member.show',$row->id) }}" class="btn aqua  btn-xs">detail</a> -->
