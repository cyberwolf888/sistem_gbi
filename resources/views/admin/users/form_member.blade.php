...
@section('content')
    ...
    <div class="wrapper-content ">
        {!! Form::open(['route' => isset($update) ? ['admin.users.member.update', $model->id] :'admin.users.member.store', 'method' => 'post']) !!}
        <div class="row">
            <!-- Basic Form start -->
            <div class="col-lg-6">
                    ...
                    <div class="widgets-container">
                        ...
                        <hr>
                            ...
                            <div class="form-group {{ $errors->has('jenis_kelamin') ? ' has-error' : '' }}">
                                ...
                                {!! Form::select('jenis_kelamin', ['1'=>'Laki-laki','0'=>'Perempuan'], $model->jenis_kelamin,['class'=>'form-control m-t-xxs']) !!}
