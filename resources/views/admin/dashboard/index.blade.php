        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="widget widget-stats mt-0 red-bg">
                    ...
                    <div class="stats-number">{{ \App\Models\PenyerahanAnak::count() }}</div>
            ...
            <div class="col-md-3 col-sm-6 mtop15">
                <div class="widget widget-stats mt-0 aqua-bg ">
                    ...
                    <div class="stats-number">{{ \App\Models\Baptisan::count() }}</div>
                    <div class="stats-progress progress">
            ...
            <div class="col-md-3 col-sm-6 mtop15">
                <div class="widget widget-stats mt-0 green-bg">
                    ...
                    <div class="stats-number">{{ \App\Models\PemberkatanNikah::count() }}</div>
                    <div class="stats-progress progress">
