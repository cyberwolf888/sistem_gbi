        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pull-right">
                    <a class="btn aqua" href="{{ route('member.pemberkatannikah.create') }}"><i class="fa fa-plus"></i> Tambah Data</a>
                </div>
            </div>
        </div>
        <div class="row">
                                ...
                                <div class="col-lg-12" >
                                    <table id="example7" class="display nowrap table  responsive nowrap table-bordered">
                                        ...
                                        @foreach($model as $row)
                                            <tr>
                                                <td>{{ $no }}</td>
                                                <td>{{ date('d F Y',strtotime($row->tgl_acara)) }}</td>
                                                <td>{{ $row->tempat }}</td>
                                                <td>{{ $row->oleh }}</td>
                                                <td>{{ $row->getStatus() }}</td>
                                                <td>
                                                    <a href="{{ route('member.pemberkatannikah.show',$row->id) }}" class="btn aqua  btn-xs">detail</a>
