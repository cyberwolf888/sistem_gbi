        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pull-right">
                    <a class="btn aqua" href="{{ route('member.baptisan.create') }}"><i class="fa fa-plus"></i> Tambah Data</a>
                </div>
            </div>
        </div>
        <div class="row">
                                    ...
                                    <table id="example7" class="display nowrap table  responsive nowrap table-bordered">
                                        ...
                                        @foreach($model as $row)
                                            <tr>
                                                <td>{{ $no }}</td>
                                                <td>{{ $row->dibaptis }}</td>
                                                <td>{{ date('d F Y',strtotime($row->tgl_baptis)) }}</td>
                                                <td>{{ $row->getStatus() }}</td>
                                                <td>
                                                    <a href="{{ route('member.baptisan.show',$row->id) }}" class="btn aqua  btn-xs">detail</a>
